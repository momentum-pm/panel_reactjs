...
export const landing_hiring = (
	<svg className={'landing-icon'} viewBox="0 0 24 24" fill="none">
		...
		<path d="M8 6V5.2C8 3.43 8 2 11.2 2H12.8C16 2 16 3.43 16 5.2V6" stroke="#292D32" strokeWidth="1.5"
		...
		<path
			...
			stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
		<path d="M21.65 11C19.34 12.68 16.7 13.68 14 14.02" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10"
			  strokeLinecap="round" strokeLinejoin="round"/>
		<path d="M2.61914 11.27C4.86914 12.81 7.40914 13.74 9.99914 14.03" stroke="#292D32" strokeWidth="1.5"
			  strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
	</svg>
);
