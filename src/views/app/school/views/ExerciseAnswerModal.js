...
class ExerciseAnswerView extends NoLoadRemoteStoreView {
    ...
    return (
      <div className="full-height">
        <Box className={"centered column full-height"}>
          ...
          <Header className={""}>راه حل</Header>

            <Scrollable c>
              <Body className={"full-with"}>
                <LatexView latex={this.getData().answer} />
              </Body>
            </Scrollable>
...
export default withRouter(connect(ExerciseAnswerView));
