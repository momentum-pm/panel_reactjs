...
export default class PhoneNumberVerification extends Form {
  static storeName = "PhoneNumberVerification";
  ...
  createFields(args) {
    return [
      CharField.create({
        ...
        hint: Res.string.profiles.code_hint_phone_number,
  ...
  static open(callback) {
    PhoneNumberVerification.get().open(callback);
  }
  ...
  open(callback) {
    ...
    this.setContext({});
    this.send();
    History.pushSmallModal("/profiles/verify-phone-number/");
  }
  ...
  send() {
    ...
    Requester.request(
      "post",
      `profiles/profiles/${App.getId()}/verification-codes/phone-number/`,
      {},
  ...
  submit() {
    ...
    if (this.isValid()) {
      ...
      Requester.request(
        "post",
        `profiles/profiles/${App.getId()}/verification-codes/phone-number/verify/${code}/`,
        {},
  ...
  getTitle(args) {
    return Res.string.profiles.phone_number_verification;
  }
}
