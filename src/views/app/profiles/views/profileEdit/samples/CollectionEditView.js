...
export default class CollectionEditView extends React.Component {
	render() {
		return (
			<div className={'sample-edit-view'}
				 onClick={() => History.pushLargeModal(`/profiles/profiles/${this.props.profileId}/collections/${this.props.collection.id}/edit/`)}>
